...
//$rfmPrms=[14,28,60,90,7,5,3,2,300000,200000,100000,30000];
        ...
        for($i=5;$i>=1;$i--){
            Log::debug("debug ログ1");
            if(empty($rCount[$i]))$rCount[$i]=0;
            if(empty($fCount[$i]))$fCount[$i]=0;
            if(empty($mCount[$i]))$mCount[$i]=0;
