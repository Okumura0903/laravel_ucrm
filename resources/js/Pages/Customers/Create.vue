                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="radio" id="gender_0" name="gender" v-model="form.gender" value="0">
                                            <label for="gender_0" class="ml-2 mr-4">男性</label>
                                            <input type="radio" id="gender_1" name="gender" v-model="form.gender" value="1">
                                            <label for="gender_1" class="ml-2 mr-4">女性</label>
                                            <input type="radio" id="gender_2" name="gender" v-model="form.gender" value="2">
