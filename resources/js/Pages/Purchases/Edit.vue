                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <InputError :message="props.errors.customer" />
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <label for="status_1"><input type="radio" id="status_1" name="status" value="1" v-model="form.status">未キャンセル</label>
                                            <label for="status_0"><input type="radio" id="status_0" name="status" value="0" v-model="form.status">キャンセルする</label>
                                            <InputError :message="props.errors.customer" />
                                        </div>
                                        </div>
